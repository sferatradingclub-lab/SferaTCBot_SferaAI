...
export async function POST(req: Request) {
  try {
    ...
    // Parse agent configuration and user details from request body
    ...
    // Prepare metadata with initData if available
    const metadata = initData ? JSON.stringify({ initData }) : undefined;
