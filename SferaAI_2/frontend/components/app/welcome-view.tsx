...
export const WelcomeView = ({
  ...
  // Создаем фиктивный analyser для демонстрации SoundWave
  const dummyAnalyser = null;
    ...
    <div ref={ref} className="relative h-screen w-screen overflow-hidden bg-gray-900">
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center text-center">
        ...
        <Button
          ...
          size="lg"
          onClick={onStartCall}
          className="mt-6 w-64 bg-cyan-500 font-mono text-gray-900 hover:bg-cyan-600"
        >
          {startButtonText}
        </Button>
        <div className="mt-8">
          <ClientOnly>
            <SoundWave isActive={false} />
          </ClientOnly>
        </div>
      </div>
