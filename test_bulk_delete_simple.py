#!/usr/bin/env python3
"""
Простое тестирование новой функциональности пакетного удаления отложенных рассылок.
"""
...
# Устанавливаем минимально необходимые переменные окружения для запуска
